...
public class SidePanel_SuperAdmin extends JPanel implements ActionListener{
    private JButton btnDashboard, btnProducts, btnInventory, btnWasteLogs, btnDelivery, btnReport, btnUsers, btnLogout;
    ...
    public void panelButtons() {
        ...
        btnReport = new JButton("   SUMMARY REPORT", new ImageIcon(reportSize));
            ...
            btnReport.setBackground(DEFAULT_COLOR);
        ...
        btnUsers = new JButton("    MANAGE USERS", new ImageIcon(userSize));
            ...
            btnUsers.setBackground(DEFAULT_COLOR);
    ...
    public void actionPerformed(ActionEvent e) {
        superAdminFrame frame = (superAdminFrame) SwingUtilities.getWindowAncestor(this);
