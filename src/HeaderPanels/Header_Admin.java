...
public class Header_Admin extends JPanel{
    private JLabel lblRole, lblIcon;

    public Header_Admin(String role)
    {
        header(role);
    ...
    {
        //tis for user
        ImageIcon userIcon = new ImageIcon(getClass().getResource("/src_pack/images/admin.png"));
